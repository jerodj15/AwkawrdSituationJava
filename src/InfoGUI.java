...
public class InfoGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Oh no there's nothing here but does there really need to be?");
        jTextArea1.setWrapStyleWord(true);
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 31, 340, 230));
